...
from code.Const import (
    C_WHITE, WIN_HEIGHT, MENU_OPTION,
    ...
    def run(self, player_score):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(14, f'Player 1 - Health: {ent.health} | Score: {ent.score}', C_GREEN, (10, 10))

                if ent.name == 'Player2':
                    self.level_text(14, f'Player 2 - Health: {ent.health} | Score: {ent.score}', C_CYAN, (10, 20))
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_TIMEOUT:
                    ...
                    if self.timeout == 0:
                        ...
                        # salva score antes de trocar de fase
                        for ent in self.entity_list:
            ...
            self.level_text(14, f'{clock.get_fps():.0f}', C_WHITE, (10, WIN_HEIGHT - 35))
